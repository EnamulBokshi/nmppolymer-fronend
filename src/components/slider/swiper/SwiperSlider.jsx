...
export const sliderContent = [
  {
    title:
      "We are <span className = 'text-blue-700 font-extrabold'>promissed</span>  to provide the <span className = 'text-violet-700'>best</span>  products",
    video: Video1,
  },
  {
  ...
  {
    title:
      "We are <span className = 'text-violet-700'>promissed</span> to serve you, <span className = 'text-yellow-400'>24/7</span>",
    video: Video2,
  },
];
export default function SwiperSlider() {

  const [sliderTitle, setSliderTitle] = useState(sliderContent[0].title);
  return (
    <>
      <Swiper
